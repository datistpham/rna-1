    ...
    >
      ...
      <View style={{ width: "100%", padding: 10, marginTop: 12 }}>
        <Text style={{ textAlign: "center", marginBottom: 8, fontSize: 24 }}>
          Đăng ký tài khoản Chat NPD
        </Text>
        <Text style={{ textAlign: "center", marginBottom: 16, fontSize: 24 }}>
          để kết nối với ứng dụng
        </Text>
        {isVerfiy === false && (
          <View
      ...
      {isVerfiy === true && (
        <View style={{ padding: 10, backgroundColor: "#fff" }}>
          <Text style={{ textAlign: "center", fontSize: 17 }}>
            Chúng tôi đã gửi đến cho bạn một mã xác thực gồm 6 chữ số vui lòng
            điền vào trường dưới đây để hoàn tất quá trình đăng ký tài khoản
          </Text>
